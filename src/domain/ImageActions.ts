...
// } from "@src/services/TranscriptionApi.ts";
...
// export const addImage = (store: TranscriptionStore, image: ImageData) => {
...
// 	(async () => {
// 		await imageRepo.storeImage(
// 			imageWithCurrentMetadata.id,
