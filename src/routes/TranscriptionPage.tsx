...
function TranscriptionPage() {
    ...
    useEffect(() => {
        if (images.length === 0 || apiKey == null) {
            console.log("Images not found, navigating to Home");
          navigate('/');
        }
