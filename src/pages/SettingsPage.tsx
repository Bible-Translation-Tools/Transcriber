...
const Settings: React.FC = () => {
  ...
  const { systemPrompt, setSystemPrompt, prompt, setPrompt, model, setModel } =
        ...
        <div className="p-8">
          <section className="py-4 border-t border-gray-300 grid grid-cols-2">
            <div>
              ...
              <p className="text-xl text-gray-600">
                Change the language that the app is displayed in. This will NOT
                affect your transcriptions.
              </p>
            </div>
          ...
          <section className="py-4 border-t border-gray-300">
            <a
              ...
              className="font-semibold mb-4 text-xl bg-white hover:bg-gray-200 py-2 px-4 rounded"
            >
              Logout
            </a>
          </section>
