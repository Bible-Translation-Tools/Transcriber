        ...
        return (
            <div className="flex flex-col w-full">
                <div className="text-sm text-blue-900">
                    ...
                    <button type={"button"} className="ml-2 text-blue-600 font-medium hover:underline hover:cursor"
                    ...
                    <section className="py-4 border-t border-gray-300 grid grid-cols-2">
                        ...
                        <div className="flex justify-start">
                            <div className="flex space-x-4">
                                ...
                                >
                                    <div
                                        className="w-32 h-24 rounded-md bg-gradient-to-r from-gray-800 to-gray-900 shadow-inner relative">
                                ...
                                >
                                    <div
                                        className="w-32 h-24 rounded-md bg-white shadow-inner border border-gray-300 relative">
                                        <div className="absolute top-1 left-1 w-2 h-2 rounded-full bg-red-500"/>
                                        <div className="absolute top-1 left-4 w-2 h-2 rounded-full bg-yellow-400"/>
                                        <div className="absolute top-1 left-7 w-2 h-2 rounded-full bg-green-500"/>
                                        <div className="absolute top-4 left-2 w-8 h-3 rounded bg-blue-500"/>
