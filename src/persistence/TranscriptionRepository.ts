import { TranscriptionImage } from "../data/TranscriptionImage";
import IndexedDBImageRepository from "./IndexedDbImageRepository";

class TranscriptionRepository {
    constructor(private db: any, private imageRepo: IndexedDBImageRepository) {}
