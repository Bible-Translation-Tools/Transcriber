...
function UploadImages() {
	...
	return (
		<div
			{...getRootProps()}
			className="flex flex-1 h-full min-h-0 w-full items-center justify-center py-15 px-20"
		>
			<div className="flex h-full min-h-0 w-full flex-1 flex-col items-center justify-center gap-4 rounded-[40px] border-2 border-dashed border-[#0056D1] bg-[#EEF0FF] p-10 cursor-pointer">
				<input
					{...getInputProps()}
					id="fileInput"
					className="hidden"
