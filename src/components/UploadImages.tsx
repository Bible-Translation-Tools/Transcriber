...
function UploadImages() {
    ...
    return (
        ...
        >
            <input {...getInputProps()} id="fileInput" className="hidden" onChange={handleFileInputChange} /> {/* Hidden file input */}

            {isDragActive ? (
                <p style={{ color: '#0F2F4C', fontSize: '26px', fontFamily: 'Noto Sans', fontWeight: '600', lineHeight: '29.90px' }}>
                    Drop the files here ...
                </p>
            ) : (
                <>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                        ...
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <span style={{ color: '#516B86', fontSize: '20px', fontFamily: 'Noto Sans', fontWeight: '400', lineHeight: '40px' }}>
                                {' '}
                                instead. This app supports most image formats, such as: PNG, JPG, PDF.
                            </span>
                        </div>
                    </div>
                </>
