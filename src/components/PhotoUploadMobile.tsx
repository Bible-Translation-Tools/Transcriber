		...
		<div className="flex flex-col items-center p-6 text-center bg-white min-h-screen">
			<div className="flex flex-col flex-1 justify-center items-center">
				...
				<p className="text-gray-600 mb-6 px-4">
					This tool converts handwritten documents into a digital
					format. While it can be very reliable, we recommend you
					review your results.
				</p>
			</div>
			<div className="flex flex-col flex-1 justify-center">
				...
				<div className="flex items-center justify-center gap-4 text-gray-500 mb-6">
					...
					<button
						type="button"
						onClick={() =>
							setTipIndex(Math.min(tips.length - 1, tipIndex + 1))
						}
						className="p-2 rounded-full bg-gray-200"
					>
						&gt;
			...
			<div className="w-full max-w-sm">
				<button
					type="button"
					className="w-full bg-blue-600 text-white py-3 rounded-lg flex items-center justify-center gap-2 mb-2"
				>
					<CameraAlt className="w-5 h-5" /> Take Photo
				</button>
				<button
					type="button"
					className="w-full border border-blue-600 text-blue-600 py-3 rounded-lg flex items-center justify-center gap-2"
				>
